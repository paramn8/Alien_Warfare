    ...
    extend: {
        ...
        fire: function (type) {
                ...
                if (type == Q.SPRITE_FRIENDLY) {
                    ...
                    shot = Q.stage().insert(new Q.Shot({ x: entity.p.x, y: entity.p.y + entity.p.h-50, speed: -200, type: Q.SPRITE_DEFAULT | Q.SPRITE_ENEMY }));
                }
...
Q.load(["spacebackground.png", "spaceship3.png","shot.png","alien.png","player.json","shot.json","alien.json"], function () {
    Q.compileSheets("spaceship3.png", "player.json");
    ...
    Q.animations("alien", { default: { frames: [0, 1], rate: 1/2 } });
    Q.stageScene("mainLevel");
